...
direct_abstract_declarator
	...
	| "(" parameter_type_list ")"		{ $$ = std::string() + ">function-param-type-list{" + " " + $2 + " " + "}function-param-type-list-end"; }
	| direct_abstract_declarator "(" ")"	{ $$ = $1 + " " + ">abstract-declarator-function()"; }
	| direct_abstract_declarator "(" parameter_type_list ")"	{ $$ = $1 + " " + ">function-param-type-list{" + " " + $3 + " " + "}function-param-type-list-end"; }
	;
